...
#import "EveryoneTableViewController.h"
...
@interface EveryoneTableViewController(){
    NSMutableArray *urls;
...
@implementation EveryoneTableViewController
...
- (id)initWithCoder:(NSCoder*)decoder
{
    ...
    if (self) {
        ...
        self.tabBarItem.title = @"Everyone";
...
- (void) requestUrls{
    ...
    NSString *request = @"/shots/everyone?page=";
